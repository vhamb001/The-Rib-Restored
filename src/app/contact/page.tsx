        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          <div className="bg-white rounded-sm border border-gray-100 shadow-sm overflow-hidden">
            <div className="grid md:grid-cols-5">
              {/* Info Side */}
              <div className="md:col-span-2 bg-[var(--color-royal-deep)] p-10 lg:p-12 text-white flex flex-col relative overflow-hidden">
                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "radial-gradient(circle at 1px 1px, white 1px, transparent 0)", backgroundSize: "24px 24px" }} />
                <div className="relative z-10 flex flex-col h-full">
                  <div className="mb-10">
                    <span className="font-script text-3xl text-[var(--color-gold)] block mb-1">Hello</span>
                    <h2 className="font-heading text-2xl font-bold text-white">Let&apos;s Connect</h2>
                    <div className="w-10 h-[2px] bg-[var(--color-gold)] mt-4" />
                  </div>
                  <p className="text-white/50 text-sm leading-[1.7] mb-10">
                  ...
                  <div className="mt-auto space-y-8">
                    <div>
                      ...
                      <a href="mailto:hello@theribrestored.com" className="text-white/60 text-sm hover:text-[var(--color-gold)] transition-colors duration-300">
